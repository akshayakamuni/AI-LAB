...
adjacency = {
    "Kuchchh":       ["Banaskantha", "Patan", "Surendranagar", "Jamnagar"],
    ...
    "Sabarkantha":   ["Banaskantha", "Mehsana", "Gandhi Nagar", "Panchmahal"],
    ...
    "Kheda":         ["Gandhi Nagar", "Ahmedabad", "Anand", "Panchmahal", "Vadodara"],
    ...
    "Rajkot":        ["Jamnagar", "Surendranagar", "Porbandar", "Amreli"],
    "Porbandar":     ["Jamnagar", "Rajkot", "Junaghad"],
    "Amreli":        ["Rajkot", "Junaghad", "Bhavnagar"],
    "Junaghad":      ["Porbandar", "Amreli", "Bhavnagar"],
    "Bhavnagar":     ["Surendranagar", "Amreli", "Junaghad"],
